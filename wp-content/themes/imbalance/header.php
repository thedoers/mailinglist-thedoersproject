...
<head>
	...
	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/style.css<?php echo '?' . filemtime( get_stylesheet_directory() . '/style.css');?>" type="text/css" media="screen" />
	...
	<?php wp_enqueue_script('team', get_template_directory_uri() . '/js/team.min.js', 'jquery', false);
			wp_enqueue_script('random', get_template_directory_uri() . '/js/jquery.random.min.js', 'jquery', false);
			wp_enqueue_script('slideto', get_template_directory_uri() . '/js/jquery.slideto.min.js', 'jquery', false);
			wp_enqueue_script('columnizer', get_template_directory_uri() . '/js/columnizer.min.js', 'jquery', false);
			wp_enqueue_script('columnize', get_template_directory_uri() . '/js/columnize.min.js', 'jquery', false);
			wp_enqueue_script('animatedcollapse', get_template_directory_uri() . '/js/animatedcollapse.min.js', 'jquery', false);
			wp_enqueue_script('collapse', get_template_directory_uri() . '/js/collapse.min.js', 'jquery', false);?>
	<?php if ( is_singular() ) wp_enqueue_script( 'comment-reply' ); ?>
	<?php wp_head(); ?>
	<?php
		if( is_front_page() || is_search() ) {
		wp_enqueue_script('jquery');
		wp_enqueue_script('grid', get_template_directory_uri() . '/js/grid.min.js', 'jquery', false);
...
<body <?php body_class(); ?>>
	...
	<div id="outer">
    	<div id="top">
        	...
        	<a href="https://twitter.com/doersproject" class="twitter-follow-button" data-show-count="true" data-width="305px" data-align="right">Follow @doersproject</a>
        </div>
        <div id="menu">
            <!--<div id="navicons">
                <ul>
            ...
            <div class="cats">
            	<ul>
                	...
                	<li class="outside"><a href="/theblog/" title="" >Go to Blog</a></li>
                </ul>
            </div>
        </div>
        <div id="projects">
